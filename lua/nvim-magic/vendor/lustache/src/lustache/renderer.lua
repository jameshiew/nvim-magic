local REQUIRE_PREFIX = 'nvim-magic.vendor.lustache.src.'

local Scanner  = require(REQUIRE_PREFIX .. "lustache.scanner")
local Context  = require(REQUIRE_PREFIX .. "lustache.context")
